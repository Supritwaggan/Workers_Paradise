            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your Worker</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Book and Pay</a></li>
...
?>								  
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              Workers <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rs.<?php echo $product['price']; ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Add Days" />
										</div>
										</form>
                                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn theme-btn">Add Days</button>
                </div>
            </div>
        </div>
    </div>
