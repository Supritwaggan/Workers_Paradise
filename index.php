...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="E:\xamp\htdocs\OnlineFood-PHP\images\icn.png" alt=""> </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/bck.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Worker</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Book Worker</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Take your service</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Mostly picked Workers</h2>
                    <p class="lead">Easiest way to get your work done!</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">Rs.'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Book Now</a> </div>
                                                </div>
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with varity of Worker's</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your Worker at your door step. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Cash on Service</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Experienced Worker's</h4> </div>
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Sedam Road oppo. ESIC Hospital,Kalaburagi.</p>
                                    <h5>Phone: 9986647497</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join thousands of other Service's who benefit from having partnered with us.</p>
                                </div>
                    </div>
                </div>
